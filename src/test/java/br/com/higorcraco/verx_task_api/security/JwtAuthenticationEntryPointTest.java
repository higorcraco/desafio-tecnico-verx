...
class JwtAuthenticationEntryPointTest {
    ...
    @Test
    void commence_shouldSetUnauthorizedStatusAndJsonContentType() throws Exception {
        MockHttpServletResponse response = new MockHttpServletResponse();
        HttpServletRequest request = mock(HttpServletRequest.class);
        when(request.getRequestURI()).thenReturn("/tasks/1");

        entryPoint.commence(request, response, new InsufficientAuthenticationException("Full authentication required"));
    ...
    @Test
    void commence_shouldWriteErrorResponseBodyWithCorrectFields() throws Exception {
        MockHttpServletResponse response = new MockHttpServletResponse();
        HttpServletRequest request = mock(HttpServletRequest.class);
        String requestUri = "/secure/endpoint";
        ...
        entryPoint.commence(request, response, new InsufficientAuthenticationException(exceptionMessage));
